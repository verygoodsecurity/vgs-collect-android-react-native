...
//    for(int i = 0;i<l.size();i++) {
//      ReactPackage rp = l.get(i);
//      if(rp instanceof VGSCollectModule) {
//        VGSCollectModule module = ()rp
//      }
//    }
////    Log.e("test!!!", "main getPackages "+l);
//    Log.e("test!!!", "------------------------->");
////    m.getOrCreateViewManagers((ReactApplicationContext)getApplicationContext())
//    Log.e("test!!!", "main getOrCreateViewManagers "+
//            m.getOrCreateViewManagers((ReactApplicationContext)getApplicationContext()));
//
//    Bundle b = new Bundle();
//    b.putParcelable("intent", data);
...
//              .emit("MyEventName", "MyEventValue");
//
//    } catch (Exception e) {
//      Log.e("test!!!", "Caught Exception: " + e.getMessage());
//    }
//  }
